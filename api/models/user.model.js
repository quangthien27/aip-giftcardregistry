...
const UserSchema = new Schema({
  fullName: {type: String, required: [true, 'Full name field is required']},
  ...
  suburb: {type: String, required: [true, 'Suburb field is required']},
  state: {type: String, required: [true, 'State field is required']},
  postcode: {type: String, required: [true, 'Postcode field is required']},
